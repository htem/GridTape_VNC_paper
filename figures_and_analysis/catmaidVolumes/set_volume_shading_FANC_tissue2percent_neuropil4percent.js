...
widget.showVolume(55, true, 'black', 0.02, true, false, false)
widget.showVolume(120, true, 'black', 0.04, true, false, false)

//If volumes are already loaded, run this
widget = CATMAID.WebGLApplication.prototype.instances[1]
widget.setVolumeStyle(55, true)
widget.setVolumeColor(55, 0x000000, 0.02)
widget.setVolumeStyle(120, true)
widget.setVolumeColor(120, 0x000000, 0.04)
