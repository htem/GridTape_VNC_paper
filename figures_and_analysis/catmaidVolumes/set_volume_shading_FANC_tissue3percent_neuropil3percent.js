...
widget.showVolume(55, true, 'black', 0.03, true, false, false)
widget.showVolume(120, true, 'black', 0.03, true, false, false)

//If volumes are already loaded, run this
widget = CATMAID.WebGLApplication.prototype.instances[1]
widget.setVolumeStyle(55, true)
widget.setVolumeColor(55, 0x000000, 0.03)
widget.setVolumeStyle(120, true)
widget.setVolumeColor(120, 0x000000, 0.03)
